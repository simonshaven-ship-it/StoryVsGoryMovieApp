...
system_prompt = f"""
    ...
    - Rule 1 (Agency): Tactical survival, hyper-competence, improvised blueprints (Add up to +2.5). MASSIVE DEDUCTION (The 'Idiot Plot' Tax): If the body count is aggressively padded by characters making hilariously stupid, illogical, or helpless decisions, heavily penalize this score.
    ...
    - Rule 4 (Narrative Puzzle): Intricate plot, high-concept narrative architecture (Add up to +2.0 * {puzzle_weight}). MASSIVE DEDUCTION: If a film relies on bizarre, unearned, or logically disconnected twists (e.g., absurd 'whodunit' reveals that make no sense), strip away points mercilessly.
